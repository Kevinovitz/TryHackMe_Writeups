...
1. Hack the machine and grab the flag from /var/www/
   ...
   First, we must setup our reverse shell. Since the server uses Node.js instead of PHP we must use a different shell from [here](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Reverse%20Shell%20Cheatsheet.md#nodejs).
